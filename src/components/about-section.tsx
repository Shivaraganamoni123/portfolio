        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-center">
          <motion.div className="md:col-span-1 flex justify-center" variants={imageVariants}>
            {profileData.profilePicture && (
              <Card className="rounded-full overflow-hidden w-48 h-48 md:w-64 md:h-64 shadow-lg bg-card/60 backdrop-blur-lg ring-2 ring-primary/50 hover:ring-primary transition-shadow duration-300 ease-in-out shadow-primary/20 hover:shadow-primary/40 profile-glow">
                <Image
